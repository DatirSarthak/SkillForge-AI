...
public class DashboardServiceImpl implements DashboardService {
    ...
    public DashboardResponseDto getDashboard(Authentication authentication) {
        ...
        StatisticsDto statistics = StatisticsDto.builder()
                .completedCourses(0)
                .completedQuizzes((int) quizAttemptRepository.countByUser(user))
                .generatedNotes((int) noteRepository.countByUser(user))
                .aiChats((int) conversationRepository.countByUser(user))
                .build();
    ...
    private List<RecentActivityDto> buildRecentActivities(User user) {
        ...
        List<Conversation> conversations =
                conversationRepository.findByUserOrderByUpdatedAtDesc(user, limit);
        ...
        List<Quiz> quizzes =
                quizRepository.findByUserOrderByCreatedAtDesc(user, limit);
        ...
        List<Roadmap> roadmaps =
                roadmapRepository.findByUserOrderByCreatedAtDesc(user, limit);
